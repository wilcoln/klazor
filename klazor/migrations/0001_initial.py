# Generated by Django 2.2.10 on 2020-09-10 16:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_folder_set', to='klazor.Folder')),
            ],
            options={
                'db_table': 'folder',
                'ordering': ['id'],
